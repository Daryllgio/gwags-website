  ...
  return (
    <section className="leadership-quote-section" style={{ background: '#0A1128', padding: '88px 28px' }}>
      <div style={{ maxWidth: '780px', margin: '0 auto', textAlign: 'center' }}>
        ...
        <div style={{ width: '72px', height: '72px', borderRadius: '50%', background: '#0F1E3D', border: '2px solid rgba(212,175,55,0.3)', margin: '0 auto 16px', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
