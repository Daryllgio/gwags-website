    ...
    <section className="cta-section" style={{ background: '#0F1E3D', padding: '96px 28px', textAlign: 'center' }}>
      <div style={{ maxWidth: '600px', margin: '0 auto' }}>
        ...
        <div className="cta-buttons" style={{ display: 'flex', gap: '14px', justifyContent: 'center', flexWrap: 'wrap' }}>
          ...
          <Link
            href="/get-involved"
            style={{ background: 'none', color: 'rgba(255,255,255,0.92)', fontSize: '15px', padding: '13px 24px', border: '0.5px solid rgba(255,255,255,0.3)', borderRadius: '3px', cursor: 'pointer', textDecoration: 'none', display: 'inline-block' }}
          >
            {c.btn2}
          </Link>
        </div>
