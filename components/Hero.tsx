  ...
  return (
    <section className="hero-section" style={{ background: '#0A1128', padding: '150px 38px', position: 'relative', overflow: 'hidden', width: '100%', boxSizing: 'border-box' }}>
      ...
      <div style={{ maxWidth: '1200px', margin: '0 auto', position: 'relative', zIndex: 1 }}>
        ...
        <h1 className="hero-h1" style={{ color: '#fff', fontSize: '45px', fontWeight: 400, lineHeight: 1.1, maxWidth: '780px', marginBottom: '24px', fontFamily: 'Georgia, serif' }}>
          {h.h1Line1}<br />
        ...
        <div className="hero-buttons" style={{ display: 'flex', gap: '14px', flexWrap: 'wrap', marginTop: h.body ? '0' : '40px' }}>
          <Link
            href="/get-involved"
            className="hero-btn"
            style={{ background: '#D4AF37', color: '#0A1128', fontSize: '16px', fontWeight: 500, padding: '14px 32px', border: 'none', borderRadius: '3px', cursor: 'pointer', letterSpacing: '0.06em', textDecoration: 'none', display: 'inline-block', textAlign: 'center' }}
          >
            {h.btn1}
          </Link>
        </div>
