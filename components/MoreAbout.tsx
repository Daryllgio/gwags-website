...
export default function MoreAbout({ lang }: MoreAboutProps) {
  ...
  return (
    <section className="more-about-section" style={{ background: '#ffffff', padding: '70px 28px' }}>
      <div style={{ maxWidth: '1200px', margin: '0 auto' }}>

        <p className="eyebrow" style={{ color: '#D4AF37', letterSpacing: '0.15em', marginBottom: '16px', fontFamily: 'inherit' }}>
          {m.heading}
        </p>
        <h2 style={{ color: '#0A1128', fontSize: '28px', fontWeight: 400, fontFamily: 'Georgia, "Times New Roman", serif', lineHeight: 1.25, marginBottom: '48px' }}>
          {m.h2}
        </h2>
