...
export default function StatsTicker({ lang }: StatsTickerProps) {
  ...
  return (
    <div className="stats-ticker" style={{ background: '#0F1E3D', borderTop: '0.5px solid rgba(212,175,55,0.14)', display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)' }}>
      {[
        { n: s.s1n, l: s.s1l },
        { n: s.s2n, l: s.s2l },
        { n: s.s3n, l: s.s3l },
        ...
        <div
          key={i}
          className={`stats-ticker-cell${i < 2 ? ' has-divider' : ''}`}
          style={{
            padding: '24px 28px',
