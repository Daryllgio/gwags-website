...
export const t = {
  en: {
    ...
    donationOverlay: {
      ...
      addressPostalLabel: 'Postal code',
  ...
  fr: {
    ...
    donationOverlay: {
      ...
      addressStreetLabel: 'Adresse',
      addressCityLabel: 'Ville',
      addressStateLabel: 'État/Province',
      addressPostalLabel: 'Code postal',
      addressCountryLabel: 'Pays',
      addressCountryPlaceholder: 'Sélectionnez un pays',
