      ...
      timeline: {
        ...
        entries: [
          ...
          },
          {
            ...
            body: 'The team organizes a second visit to the Ami de Jésus orphanage, this time partnering with a Cameroonian organization called Codam Technologies to provide hands-on technology exposure to the children. The children are introduced to 3D printing, introductory coding, and digital tools for the first time.',
      ...
      timeline: {
        ...
        entries: [
          ...
          },
          {
            ...
            body: "L'équipe organise une deuxième visite à l'orphelinat Ami de Jésus, cette fois en partenariat avec une organisation camerounaise appelée Codam Technologies pour offrir aux enfants une exposition pratique à la technologie. Les enfants sont initiés à l'impression 3D, à l'initiation au codage et aux outils numériques pour la première fois.",
