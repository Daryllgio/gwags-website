...
export const t = {
  en: {
    ...
    donationOverlay: {
      ...
      manageDescription: "If you signed up for a monthly donation, enter the email address you used to donate. We'll take you to your secure portal to manage or cancel your recurring donation.",
  ...
  fr: {
    ...
    donationOverlay: {
      ...
      manageDescription: 'Si vous avez souscrit un don mensuel, saisissez l\'adresse email que vous avez utilisée pour donner. Nous vous redirigerons vers votre espace sécurisé pour gérer ou annuler votre don récurrent.',
      manageEmailLabel: 'Email',
