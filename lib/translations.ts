...
export const t = {
  en: {
      ...
      timeline: {
        ...
        entries: [
          ...
          },
          {
            ...
            body: "In partnership with several organizations including the Ministry of Public Health of Cameroon and the Cameroon English Speaking Medical Students' Association (CAMESA), Gwags supported a 5-day health outreach campaign in the Nguti Health District, located in Cameroon's South West Region. The campaign deployed 120 medical personnel to provide free consultations, surgeries, screenings, and health education to over 1,500 people across the district.",
    ...
    terms: {
      ...
      sections: [
        { heading: '1. Introduction', body: ['These Terms of Use ("Terms") constitute an agreement between you (the "user") and Gwags Global Impact Institution ("Gwags", "we", "us", "our") governing your use of this website. By accessing or using the site, you agree to be bound by these Terms. If you do not agree, please do not use the site.'] },
        { heading: '2. Eligibility', body: ["You must be at least 18 years old or the age of majority in your jurisdiction to use this site. If you are using the site on behalf of an organization, you represent that you are authorized to accept these Terms on that organization's behalf."] },
        { heading: '3. Use of the Site', body: ['We grant you a limited, non-exclusive, non-transferable license to access the site for personal, non-commercial purposes. You may not: misuse the site, interfere with its operation, upload harmful or malicious content, infringe intellectual property rights, use the site for unlawful purposes, or attempt to gain unauthorized access to any part of the site.'] },
        { heading: '4. Intellectual Property', body: ['All content on the site, including text, graphics, logos, and images, is the property of Gwags or its licensors and is protected by intellectual property laws. You may not reproduce, distribute, or create derivative works from this content without our prior written consent.'] },
        { heading: '5. Submissions', body: ['Any information you submit through our contact or partnership forms is provided voluntarily. You represent that you have the right to provide such information and that it does not violate any third-party rights.'] },
        { heading: '6. Donations', body: ["Donations are processed securely through Stripe, a third-party payment processor. By donating, you agree to Stripe's terms and privacy policy. Donations are generally non-refundable. If you believe a donation was made in error, you may contact us within 30 days at donate@gwags.org and we will review your request."] },
        { heading: '7. Third-Party Links', body: ['The site may contain links to third-party websites. Gwags is not responsible for the content, policies, or practices of these external sites.'] },
        { heading: '8. Disclaimer of Warranties', body: ['The site and its content are provided "as is" and "as available" without warranties of any kind, whether express or implied. Gwags does not warrant that the site will be error-free, secure, or uninterrupted.'] },
        { heading: '9. Limitation of Liability', body: ['To the maximum extent permitted by law, Gwags shall not be liable for any indirect, incidental, or consequential damages arising from your use of the site.'] },
        { heading: '10. Changes to These Terms', body: ['Gwags may update these Terms at any time. Your continued use of the site after changes are posted constitutes acceptance of the updated Terms.'] },
        { heading: '11. Governing Law', body: ['These Terms are governed by the laws of the jurisdictions in which Gwags Global Impact Institution is incorporated (the United States and Cameroon), without regard to conflict of law principles.'] },
        { heading: '12. Contact', body: ['For questions about these Terms, contact us at contact@gwags.org.'] },
      ],
    },
    privacy: {
  ...
  fr: {
      ...
      timeline: {
        ...
        entries: [
          ...
          },
          {
            ...
            body: "En partenariat avec plusieurs organisations, dont le Ministère de la Santé Publique du Cameroun et la Cameroon English Speaking Medical Students' Association (CAMESA), Gwags a soutenu une campagne de sensibilisation sanitaire de 5 jours dans le district de santé de Nguti, situé dans la région du Sud-Ouest du Cameroun. La campagne a déployé 120 personnels médicaux pour fournir des consultations gratuites, des chirurgies, des dépistages et une éducation sanitaire à plus de 1 500 personnes à travers le district.",
            photo: '/images/health-outreach/nguti-health-campaign/2T8A1050_copy.jpg',
          },
          {
    ...
    terms: {
      ...
      sections: [
        ...
        { heading: '5. Soumissions', body: ["Toute information que vous soumettez via nos formulaires de contact ou de partenariat est fournie volontairement. Vous déclarez avoir le droit de fournir ces informations et qu'elles ne violent aucun droit de tiers."] },
        { heading: '6. Dons', body: ["Les dons sont traités de manière sécurisée via Stripe, un processeur de paiement tiers. En faisant un don, vous acceptez les conditions et la politique de confidentialité de Stripe. Les dons sont généralement non remboursables. Si vous pensez qu'un don a été effectué par erreur, vous pouvez nous contacter dans un délai de 30 jours à donate@gwags.org et nous examinerons votre demande."] },
        { heading: '7. Liens tiers', body: ["Le site peut contenir des liens vers des sites web tiers. Gwags n'est pas responsable du contenu, des politiques ou des pratiques de ces sites externes."] },
