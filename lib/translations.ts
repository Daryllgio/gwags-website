...
export const t = {
  en: {
    ...
    initiatives: {
      ...
      items: [
        { title: 'Gwags Scholars Program', desc: 'Providing educational funding and professional development opportunities to students across Cameroon.', tag: 'EXCELLENCE' },
    ...
    partnerPage: {
      ...
      sectorOtherPlaceholder: 'Please specify your sector',
      sectorOtherRequired: 'Please specify your sector.',
    },
    donationOverlay: {
      giveOnce: 'Give once',
      monthly: 'Monthly',
      ...
      manageTriggerLink: 'Manage your monthly donation.',
      ...
      manageDescription: "If you signed up for a monthly donation, enter the email address you used to donate. If we find a match, we'll email you a secure link to manage or cancel your recurring donation.",
      manageEmailLabel: 'Email',
      manageSubmit: 'Send me a secure link',
      manageEmailInvalid: 'Please enter a valid email address.',
      manageSent: "If a matching recurring donation exists, we've sent a secure management link to that email address. It expires in 15 minutes.",
      ...
      transactionCostInfoLabel: 'Transaction cost info',
      minDonationNoticePrefix: 'The minimum donation amount is ',
      minDonationNoticeAmount: '$5',
      amountRequiredError: 'Please select or enter an amount.',
      firstNameLabel: 'First Name',
      lastNameLabel: 'Last Name',
      emailFieldLabel: 'Email',
      requiredError: 'Required',
      emailInvalidShort: 'Please enter a valid email address',
      acceptTermsPrefix: 'I accept the',
      termsLinkLabel: 'Terms of Use',
      andConnector: 'and',
      privacyLinkLabel: 'Privacy Policy',
      acceptTermsRequired: 'Please accept the Terms of Use and Privacy Policy.',
      continueBtn: 'Continue',
      orOtherMethods: 'Or donate with other methods',
      cardNumberPlaceholder: 'Card Number',
      cardDetailsRequired: 'Please complete your card details.',
      coverFeeLabel: 'Cover the transaction cost',
      feeTooltipPrefix: 'By adding ',
      feeTooltipSuffix: ', you help cover the necessary software and processing fees',
      totalLabel: 'Total',
      payWithApplePay: 'Pay with Apple Pay',
      payWithGooglePay: 'Pay with Google Pay',
      exampleEmailPlaceholder: 'you@example.com',
      paymentRequestLabel: 'Gwags Donation',
      exitTitle: 'Maybe next time?',
      exitBody: "Please leave your email address below, and we'll send you a gentle reminder later.",
      exitEmailLabel: 'Email *',
      exitEmailRequired: 'Email is required.',
      exitSentMessage: "We'll remind you!",
      remindMeLaterBtn: 'Remind me later',
      noThanksBtn: 'No thanks',
      howDidYouHearTitle: 'How did you hear about us?',
      referralOptions: {
        friendOrFamily: 'Friend or family',
        linkedIn: 'LinkedIn',
        searchEngine: 'Search engine',
        gwagsEvent: 'Gwags event or website',
        workplace: 'Workplace or employer',
        email: 'Email',
      ...
      nextLabel: 'Next',
      donationSuccessfulBanner: 'Donation successful',
      thankYouForSupport: 'Thank you for your support!',
      youveMadeADonationPrefix: 'We have received your $',
      youveMadeADonationSuffix: ' USD donation.',
      nowMonthlySupporterText: 'You are now a monthly supporter.',
      becomeMonthlySupporterTitle: 'Become a monthly supporter',
      becomeMonthlySupporterBody: 'Monthly donations ensure continuous support of our mission. Would you like to become a monthly supporter?',
      usdPerMonthSuffix: ' USD/mo',
      orAnotherAmountLink: 'or another amount',
      yesGiveMonthlyBtn: "Yes, I'll give monthly",
      notAtThisTimeBtn: 'Not at this time',
      closeLink: 'Close',
    },
    donationFaq: {
      secure: {
    ...
    howWeWork: {
      ...
      initiatives: {
        ...
        items: [
          { title: 'Gwags Scholars Program', desc: 'Providing educational funding and professional development opportunities to students across Cameroon.', tag: 'EXCELLENCE', href: '/initiatives/scholars' },
        ...
        entries: [
          {
            ...
            body: 'Four high school students in Douala, Cameroon, had to undertake a community service project as part of their academic program. They organized a visit to the Coeur de Jésus orphanage, where they spent time with the children, provided essential supplies, and witnessed the realities these children faced daily.',
            photo: '/images/ajong-foretia/coeur-de-jesus/DSC_1171.JPG',
          },
          {
            year: '2022', month: 'DECEMBER',
            title: 'Partnership with Codam Technologies',
            body: 'The team organized a second visit to the Ami de Jésus orphanage, this time partnering with Codam Technologies, a Cameroonian organization committed to advancing digital literacy among youth, to provide hands-on technology exposure to the children. The children were introduced to 3D printing, introductory coding, and digital tools for the first time.',
          ...
          },
          {
            ...
            body: 'Gwags launched the Gwags Scholars Program, an initiative designed to support outstanding university students across Cameroon by funding their education and providing professional development opportunities that prepare them for the transition into the workforce.',
            photo: '/images/scholars/program-cover.jpg',
          },
          {
            year: '2026', month: 'JULY',
            title: 'Launch of the Mbal Lekeaka Fund',
            body: 'Gwags established the Mbal Lekeaka Fund, a grant program designed to support community-led initiatives that struggle to scale or sustain their activities due to limited access to financial resources.',
            photo: 'Photo: community initiative',
          },
          {
            year: '2026', month: 'AUGUST',
            title: 'First Health Outreach Campaign',
            body: "Gwags partnered with the Cameroon English Speaking Medical Students' Association (CAMESA) to support a week-long medical campaign across the Nguti Health District. Conducted in collaboration with the Ministry of Public Health of Cameroon and several other organizations, the campaign mobilized 120 medical personnel and benefited over 1,700 people across the district.",
          ...
          },
          {
            ...
            body: 'Gwags formally evolved beyond a foundation model, repositioning itself as a Global Impact Institution dedicated to structuring, coordinating, and accelerating initiatives committed to the sustainable transformation of societies.',
    ...
    ourRole: {
      hero: {
        ...
        body: 'Across the world, organizations are working to tackle the challenges their communities face. But ambition without infrastructure rarely translates into lasting impact. Gwags bridges that gap by providing the institutional framework that turns commitment into sustained, measurable change.',
      },
      visionMission: {
        vision: {
          label: 'OUR VISION',
      ...
      carousel: {
        ...
        events: [
          { label: '2026 Cohort', href: '/initiatives/scholars/2026', imagePosition: 'top', cardVariant: 'scholars', items: [
            '/images/scholars/chia-rozel.jpg',
            '/images/scholars/jores-junior-tapa.jpg',
            '/images/scholars/asonganyi-yufanyi.jpg',
            '/images/scholars/glorya-odrey-nguessop.jpg',
            '/images/scholars/nchia-dze-desmond.jpg',
            '/images/scholars/ines-patricia-kouna.jpg',
            '/images/scholars/fon-precious-fri.jpg',
            '/images/scholars/madeleine-tchanchou-wandji.jpg',
            '/images/scholars/emily-success-azem.jpg',
            '/images/scholars/ngwa-harriette-bih.jpg',
          ] },
        ],
      },
    },
    scholarsBatches: {
      '2026': {
        ...
        scholars: [
          { name: 'Chia Rozel', program: 'Pharmacy', university: 'University of Bamenda', image: '/images/scholars/chia-rozel.jpg' },
          { name: 'Jores Junior Tapa', program: 'Civil Engineering', university: 'University of Yaoundé 1', image: '/images/scholars/jores-junior-tapa.jpg' },
          { name: 'Asonganyi Yufanyi', program: 'Nursing Science', university: 'University of Buea', image: '/images/scholars/asonganyi-yufanyi.jpg' },
          { name: 'Glorya Odrey Nguessop', program: 'Management & Finance', university: 'Prepa Saint Jean', image: '/images/scholars/glorya-odrey-nguessop.jpg' },
          { name: 'Nchia Dze Desmond', program: 'Medicine', university: 'University of Buea', image: '/images/scholars/nchia-dze-desmond.jpg' },
          { name: 'Ines Patricia Kouna', program: 'Mathematics, Statistics and Computer Science', university: 'University of Bertoua', image: '/images/scholars/ines-patricia-kouna.jpg' },
          { name: 'Fon Precious Fri', program: 'Economic Science', university: 'University of Yaoundé 2', image: '/images/scholars/fon-precious-fri.jpg' },
          { name: 'Madeleine Tchanchou Wandji', program: 'Geography', university: 'University of Douala', image: '/images/scholars/madeleine-tchanchou-wandji.jpg' },
          { name: 'Emily Success Azem', program: 'Pharmacy', university: 'University of Buea', image: '/images/scholars/emily-success-azem.jpg' },
          { name: 'Ngwa Harriette Bih', program: 'Nursing', university: 'University of Bamenda', image: '/images/scholars/ngwa-harriette-bih.jpg' },
        ],
      },
    },
    mbalLekeakaPage: {
  ...
  fr: {
      ...
      dropdowns: {
        ...
        work: {
          ...
          links: [
            ...
            { label: 'Programme de Santé Communautaire', href: '/initiatives/health-outreach' },
    ...
    initiatives: {
      ...
      items: [
        { title: 'Programme Gwags Scholars', desc: 'Offrir un financement éducatif et des opportunités de développement professionnel aux étudiants à travers le Cameroun.', tag: 'EXCELLENCE' },
    ...
    whyGwags: {
      ...
      body: 'Les organisations affiliées à Gwags gagnent en visibilité, en poids institutionnel, en accès à un réseau global et en soutien structurel nécessaire pour croître avec crédibilité et détermination.',
      items: [
    ...
    partnerPage: {
      ...
      sectorOtherPlaceholder: 'Veuillez préciser votre secteur',
    ...
    donationOverlay: {
      ...
      manageTriggerLink: 'Gérer votre don mensuel.',
      ...
      manageDescription: 'Si vous avez souscrit un don mensuel, saisissez l\'adresse email que vous avez utilisée pour donner. Si nous trouvons une correspondance, nous vous enverrons un lien sécurisé pour gérer ou annuler votre don récurrent.',
      manageEmailLabel: 'Email',
      manageSubmit: 'M\'envoyer un lien sécurisé',
      manageEmailInvalid: 'Veuillez saisir une adresse email valide.',
      manageSent: 'Si un don récurrent correspondant existe, nous avons envoyé un lien de gestion sécurisé à cette adresse email. Il expire dans 15 minutes.',
      ...
      chooseAmountTitle: 'Choisissez votre montant',
      enterDetailsTitle: 'Renseignez vos coordonnées',
      paymentTitle: 'Paiement',
      transactionCostInfoLabel: 'Informations sur les frais de transaction',
      minDonationNoticePrefix: 'Le montant minimum du don est de ',
      minDonationNoticeAmount: '5 $',
      amountRequiredError: 'Veuillez sélectionner ou saisir un montant.',
      firstNameLabel: 'Prénom',
      lastNameLabel: 'Nom de famille',
      emailFieldLabel: 'Email',
      requiredError: 'Requis',
      emailInvalidShort: 'Veuillez saisir une adresse email valide',
      ...
      orOtherMethods: 'Ou faites un don par un autre moyen',
      cardNumberPlaceholder: 'Numéro de carte',
      cardDetailsRequired: 'Veuillez compléter les informations de votre carte.',
      coverFeeLabel: 'Prendre en charge les frais de transaction',
      feeTooltipPrefix: 'En ajoutant ',
      feeTooltipSuffix: ', vous contribuez à couvrir les frais logiciels et de traitement nécessaires',
      totalLabel: 'Total',
      payWithApplePay: 'Payer avec Apple Pay',
      payWithGooglePay: 'Payer avec Google Pay',
      exampleEmailPlaceholder: 'vous@exemple.com',
      paymentRequestLabel: 'Don Gwags',
      exitTitle: 'Peut-être une prochaine fois ?',
      exitBody: 'Laissez votre adresse email ci-dessous et nous vous enverrons un rappel amical plus tard.',
      exitEmailLabel: 'Email *',
      exitEmailRequired: "L'adresse email est requise.",
      exitSentMessage: 'Nous vous enverrons un rappel !',
      remindMeLaterBtn: 'Me rappeler plus tard',
      noThanksBtn: 'Non merci',
      howDidYouHearTitle: 'Comment avez-vous entendu parler de nous ?',
      referralOptions: {
        friendOrFamily: 'Ami ou famille',
        linkedIn: 'LinkedIn',
        searchEngine: 'Moteur de recherche',
        gwagsEvent: 'Événement ou site web de Gwags',
        workplace: 'Lieu de travail ou employeur',
        email: 'Courriel',
        partnerOrg: 'Organisation partenaire',
        other: 'Autre',
        preferNotToSay: 'Je préfère ne pas répondre',
      },
      pleaseSelectOneOption: 'Veuillez sélectionner au moins une option.',
      nextLabel: 'Suivant',
      donationSuccessfulBanner: 'Don réussi',
      thankYouForSupport: 'Merci pour votre soutien !',
      youveMadeADonationPrefix: 'Nous avons bien reçu votre don de ',
      youveMadeADonationSuffix: ' $ USD.',
      nowMonthlySupporterText: 'Vous êtes maintenant donateur mensuel.',
      becomeMonthlySupporterTitle: 'Devenez donateur mensuel',
      becomeMonthlySupporterBody: 'Les dons mensuels assurent un soutien continu à notre mission. Souhaitez-vous devenir donateur mensuel ?',
      usdPerMonthSuffix: ' $ USD/mois',
      orAnotherAmountLink: 'ou un autre montant',
      yesGiveMonthlyBtn: 'Oui, je donnerai mensuellement',
      notAtThisTimeBtn: 'Pas pour le moment',
      closeLink: 'Fermer',
    },
    donationFaq: {
      secure: {
    ...
    howWeWork: {
      ...
      split: {
        left: {
          ...
          body: [
            "Gwags conçoit et met en œuvre des programmes qui répondent aux besoins sur le terrain. Le portefeuille actuel couvre l'éducation, la santé, le développement communautaire et l'autonomisation des jeunes. Chaque initiative a été créée pour combler un manque identifié à travers un engagement direct avec les communautés que nous servons.",
            "Gérer ces initiatives nous fournit une expérience opérationnelle directe. Nous comprenons les défis de la mise en œuvre parce que nous les affrontons nous-mêmes. Cette compréhension rend le soutien que nous offrons aux organisations affiliées plus ancré et plus crédible.",
          ],
        },
        right: {
      ...
      initiatives: {
        ...
        items: [
          { title: 'Programme Gwags Scholars', desc: 'Offrir un financement éducatif et des opportunités de développement professionnel aux étudiants à travers le Cameroun.', tag: 'EXCELLENCE', href: '/initiatives/scholars' },
        ...
        entries: [
          {
            ...
            body: "Quatre lycéens à Douala, au Cameroun, doivent réaliser un projet de service communautaire dans le cadre de leur programme scolaire. Ils organisent une visite à l'orphelinat Cœur de Jésus, où ils passent du temps avec les enfants, fournissent des fournitures essentielles et constatent les réalités auxquelles ces enfants font face au quotidien.",
            photo: '/images/ajong-foretia/coeur-de-jesus/DSC_1171.JPG',
          },
          {
            year: '2022', month: 'DÉCEMBRE',
            title: 'Partenariat avec Codam Technologies',
            body: "L'équipe organise une deuxième visite à l'orphelinat Ami de Jésus, cette fois en partenariat avec Codam Technologies, une organisation camerounaise vouée à la formation des jeunes aux technologies numériques, pour offrir aux enfants une exposition pratique à la technologie. Les enfants ont bénéficié d'une introduction à l'impression 3D, au codage et aux outils numériques.",
            photo: '/images/ajong-foretia/codam-tech/654202991_18087992795267535_1459227050299309829_n.jpg',
          },
          {
            year: '2025', month: 'MAI',
            title: 'Création et Incorporation de la Fondation Gwags',
            body: "Gwags formalise sa structure en créant et en incorporant la Fondation Gwags en tant qu'organisation à but non lucratif aux États-Unis et au Cameroun, établissant les bases juridiques et institutionnelles pour des opérations internationales durables.",
            photo: '',
          },
          {
            year: '2026', month: 'JANVIER',
            title: 'Lancement du Programme Gwags Scholars',
            body: "Gwags lance le Programme Gwags Scholars, une initiative conçue pour soutenir les étudiants universitaires exceptionnels à travers le Cameroun en finançant leurs études et en offrant des opportunités de développement professionnel qui les préparent à la transition vers le monde du travail.",
            photo: '/images/scholars/program-cover.jpg',
          },
          {
            year: '2026', month: 'JUILLET',
            title: 'Lancement du Fonds Mbal Lekeaka',
            body: "Gwags met en place le Fonds Mbal Lekeaka, un programme de subventions conçu pour soutenir les initiatives communautaires qui peinent à se développer ou à maintenir leurs activités en raison d'un accès limité aux ressources financières.",
            photo: 'Photo: initiative communautaire',
          },
          {
            year: '2026', month: 'AOÛT',
            title: 'Première Campagne de Santé Communautaire',
            body: "Gwags s'associe à l'Association des étudiants en médecine anglophone du Cameroun (CAMESA) pour soutenir une campagne médicale d'une semaine à travers le district de santé de Nguti. Menée en collaboration avec le Ministère de la Santé Publique du Cameroun et plusieurs autres organisations, la campagne a mobilisé 120 personnels médicaux et a bénéficié à plus de 1 700 personnes à travers le district.",
            photo: '/images/health-outreach/nguti-health-campaign/2T8A1064.jpg',
          },
          {
            year: '2026', month: 'SEPTEMBRE',
            title: "Transition vers Institution d'Impact Global",
            body: "Gwags évolue formellement au-delà du modèle de fondation, se repositionnant en tant qu'Institution d'Impact Global dédiée à la structuration, la coordination et l'accélération des initiatives engagées dans la transformation durable des sociétés.",
            photo: '/images/general/WhatsApp_Image_2026-06-23_at_10_07_06.jpeg',
          },
        ],
      },
    ...
    ourRole: {
      hero: {
        ...
        body: "À travers le monde, des organisations s'efforcent de relever les défis auxquels font face leurs communautés. Mais l'ambition sans infrastructure se traduit rarement en impact durable. Gwags comble ce vide en offrant le cadre institutionnel qui transforme l'engagement en changement mesurable et pérenne.",
      },
      visionMission: {
        vision: {
          label: 'NOTRE VISION',
      ...
      sections: [
        ...
        },
        {
          ...
          richBody: [
            ...
            { label: 'Ce que les boursiers reçoivent', text: 'Une bourse de 150 000 FCFA et un accès à des placements en stage. Le programme sélectionne 10 boursiers par promotion.' },
    ...
    scholarsBatches: {
      '2026': {
        ...
        scholars: [
          { name: 'Chia Rozel', program: 'Pharmacie', university: 'Université de Bamenda', image: '/images/scholars/chia-rozel.jpg' },
          { name: 'Jores Junior Tapa', program: 'Génie civil', university: 'Université de Yaoundé 1', image: '/images/scholars/jores-junior-tapa.jpg' },
          { name: 'Asonganyi Yufanyi', program: 'Sciences infirmières', university: 'Université de Buea', image: '/images/scholars/asonganyi-yufanyi.jpg' },
          { name: 'Glorya Odrey Nguessop', program: 'Gestion et Finance', university: 'Prepa Saint Jean', image: '/images/scholars/glorya-odrey-nguessop.jpg' },
          { name: 'Nchia Dze Desmond', program: 'Médecine', university: 'Université de Buea', image: '/images/scholars/nchia-dze-desmond.jpg' },
          { name: 'Ines Patricia Kouna', program: 'Mathématiques, Statistiques et Informatique', university: 'Université de Bertoua', image: '/images/scholars/ines-patricia-kouna.jpg' },
          { name: 'Fon Precious Fri', program: 'Sciences économiques', university: 'Université de Yaoundé 2', image: '/images/scholars/fon-precious-fri.jpg' },
          { name: 'Madeleine Tchanchou Wandji', program: 'Géographie', university: 'Université de Douala', image: '/images/scholars/madeleine-tchanchou-wandji.jpg' },
          { name: 'Emily Success Azem', program: 'Pharmacie', university: 'Université de Buea', image: '/images/scholars/emily-success-azem.jpg' },
          { name: 'Ngwa Harriette Bih', program: 'Soins infirmiers', university: 'Université de Bamenda', image: '/images/scholars/ngwa-harriette-bih.jpg' },
        ],
      },
    },
    mbalLekeakaPage: {
