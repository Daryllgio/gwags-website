...
export const t = {
  en: {
    ...
    ourStoryPage: {
      ...
      photoBanner: '/images/mbal-lekeaka-fund/hero.jpg',
      narrative: [
      ...
      timeline: {
        ...
        entries: [
          ...
          },
          {
            ...
            photo: '/images/mbal-lekeaka-fund/hero.jpg',
          },
          {
    ...
    scholarsBatches: {
      '2026': {
        ...
        scholars: [
          ...
          { name: 'Jores Junior Tapa', program: 'Génie civil', university: 'Université de Yaoundé 1', image: '/images/scholars/scholar-02.jpg' },
