  ...
  return (
    <section style={{ background: '#0A1128', padding: '88px 28px 96px', position: 'relative', overflow: 'hidden' }}>
      ...
      <div style={{ maxWidth: '1200px', margin: '0 auto', position: 'relative', zIndex: 1 }}>
        <p style={{ color: '#D4AF37', fontSize: '11px', letterSpacing: '0.25em', marginBottom: '24px' }}>
          {h.eyebrow}
        </p>
        ...
        <p style={{ color: 'rgba(255,255,255,0.6)', fontSize: '17px', lineHeight: 1.78, maxWidth: '500px', marginBottom: '44px' }}>
          {h.body}
        </p>
