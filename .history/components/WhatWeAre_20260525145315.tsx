  ...
  return (
    <section style={{ background: '#fff', padding: '80px 28px' }}>
      <div style={{ maxWidth: '1200px', margin: '0 auto', display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '72px', alignItems: 'start' }} className="whatweare-grid">
        ...
        <div>
          <p style={{ color: '#D4AF37', fontSize: '14px', letterSpacing: '0.22em', marginBottom: '16px' }}>
            {w.eyebrow}
          </p>
          <h2 style={{ color: '#0A1128', fontSize: '34px', fontWeight: 400, fontFamily: 'Georgia, serif', lineHeight: 1.25, marginBottom: '20px' }}>
            {w.h2}
          </h2>
          <p style={{ color: '#4A4A4A', fontSize: '19px', lineHeight: 1.82, marginBottom: '16px' }}>{w.p1}</p>
          <p style={{ color: '#4A4A4A', fontSize: '19px', lineHeight: 1.82, marginBottom: '16px' }}>{w.p2}</p>
          <p style={{ color: '#4A4A4A', fontSize: '19px', lineHeight: 1.82, marginBottom: '28px' }}>{w.p3}</p>
