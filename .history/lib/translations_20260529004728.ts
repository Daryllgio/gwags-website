...
export const t = {
  en: {
    ...
    ourStoryPage: {
      ...
      narrative: [
        'It started with four students and a school project in Douala, Cameroon.',
        'In December 2021, as part of an academic initiative, a small team visited the Ami de Jesuite orphanage. The goal was straightforward: complete a community service assignment. But what they found there changed the trajectory of everything that followed. They met children with limited resources, few opportunities, and no shortage of potential. The gaps were obvious, but so was the possibility of what consistent, structured support could unlock.',
        'That visit was supposed to be a one-time commitment. It became the origin of something much larger.',
        'The team returned. They organized a second initiative the following year, this time partnering with a local tech education startup to introduce children to digital tools, 3D printing, and hands-on technology for the first time. The scope had already grown beyond basic support. The question was no longer whether to continue, but how to build something that could sustain itself and scale.',
        'Over the months that followed, the founders reflected on the deeper challenges they were witnessing. The barriers facing children and young people across Cameroon were not isolated. They were systemic. Educational gaps, healthcare shortages, limited access to technology, weak institutional support. No single project could address all of it. But a well-structured organization, one designed to coordinate across sectors and connect the right people with the right resources, could begin to change the equation.',
        'That conviction led to a series of decisive steps. Gwags was formally incorporated as a nonprofit in the United States, establishing the legal and institutional foundation for international operations. New initiatives followed, spanning education, community development, healthcare, and youth empowerment. What had started as orphanage visits was becoming a multi-sector institution with a growing portfolio of programs and partnerships.',
        "But the more the team built, the clearer something became. Running individual programs was not enough. The real challenge was not just delivering impact, it was structuring it. Across the world, there were countless organizations and initiatives doing meaningful work but struggling with the same obstacles: limited funding, weak governance, no access to networks, and no institutional backbone to help them grow.",
        "That realization marked the most important shift in Gwags's journey. The mission was no longer just about what Gwags could do directly. It was about building the infrastructure that would enable others to do more. An institution that could coordinate, support, and strengthen the organizations and leaders already committed to change. A platform where credibility, structure, and international reach could be shared, not hoarded.",
        'In September 2026, Gwags formally transitioned from a foundation into a Global Impact Institution. The name changed. The positioning changed. But the conviction that started it all remained exactly the same: invest in people, build with intention, and never treat support as something temporary.',
  ...
  fr: {
    ...
    footer: {
      ...
      col1: { heading: 'INSTITUTION', links: [
        { label: 'À propos de Gwags', href: '/about' },
        { label: 'Notre histoire', href: '/about/our-story' },
        { label: 'Comment nous travaillons', href: '/about/how-we-work' },
        { label: 'Notre rôle', href: '/about/our-role' },
      ]},
    ...
    ourStoryPage: {
      ...
      narrative: [
        'Tout a commencé avec quatre étudiants et un projet scolaire à Douala, au Cameroun.',
        "En décembre 2021, dans le cadre d'une initiative académique, une petite équipe a visité l'orphelinat Ami de Jesuite. L'objectif était simple: accomplir une mission de service communautaire. Mais ce qu'ils y ont découvert a changé la trajectoire de tout ce qui a suivi. Ils ont rencontré des enfants disposant de peu de ressources, de rares opportunités, mais d'un potentiel indéniable. Les lacunes étaient évidentes, tout comme la possibilité qu'un soutien constant et structuré pouvait ouvrir.",
        "Cette visite était censée être un engagement ponctuel. Elle est devenue l'origine de quelque chose de bien plus grand.",
        "L'équipe est revenue. Elle a organisé une deuxième initiative l'année suivante, cette fois en partenariat avec une startup locale d'éducation technologique, pour initier des enfants aux outils numériques, à l'impression 3D et aux technologies pratiques pour la première fois. La portée avait déjà dépassé le simple soutien de base. La question n'était plus de savoir s'il fallait continuer, mais comment construire quelque chose qui puisse se maintenir et évoluer.",
        "Dans les mois qui ont suivi, les fondateurs ont réfléchi aux défis plus profonds qu'ils observaient. Les obstacles auxquels faisaient face les enfants et les jeunes à travers le Cameroun n'étaient pas isolés. Ils étaient systémiques. Des lacunes éducatives, des pénuries de soins de santé, un accès limité à la technologie, un soutien institutionnel insuffisant. Aucun projet ne pouvait tout résoudre seul. Mais une organisation bien structurée, conçue pour coordonner les secteurs et mettre en relation les bonnes personnes avec les bonnes ressources, pouvait commencer à changer la donne.",
        "Cette conviction a conduit à une série d'étapes décisives. Gwags a été officiellement constituée en association à but non lucratif aux États-Unis, établissant les bases juridiques et institutionnelles pour des opérations internationales. De nouvelles initiatives ont suivi, couvrant l'éducation, le développement communautaire, la santé et l'autonomisation des jeunes. Ce qui avait commencé par des visites à l'orphelinat devenait une institution multisectorielle avec un portefeuille croissant de programmes et de partenariats.",
        "Mais plus l'équipe construisait, plus quelque chose devenait évident. Gérer des programmes individuels ne suffisait pas. Le vrai défi ne consistait pas seulement à créer de l'impact, mais à le structurer. À travers le monde, d'innombrables organisations et initiatives accomplissaient un travail significatif, mais se heurtaient aux mêmes obstacles: financement limité, gouvernance fragile, absence de réseaux, et absence de structure institutionnelle pour soutenir leur croissance.",
        "Cette prise de conscience a marqué le tournant le plus important du parcours de Gwags. La mission ne consistait plus seulement à agir directement. Il s'agissait de construire l'infrastructure qui permettrait à d'autres d'en faire davantage. Une institution capable de coordonner, soutenir et renforcer les organisations et les leaders déjà engagés dans le changement. Une plateforme où crédibilité, structure et portée internationale pourraient être partagées, et non gardées jalousement.",
        "En septembre 2026, Gwags a officiellement évolué, passant d'une fondation à une Institution d'Impact Mondial. Le nom a changé. Le positionnement a changé. Mais la conviction qui avait tout déclenché est restée exactement la même: investir dans les personnes, construire avec intention, et ne jamais traiter le soutien comme quelque chose de temporaire.",
        "Aujourd'hui, Gwags opère dans plusieurs pays et secteurs, construisant un écosystème conçu pour accélérer l'impact à grande échelle. Les programmes continuent de se développer. Le réseau continue de s'étendre. Et l'infrastructure qui permettra à des générations d'organisations et de communautés de transformer leurs sociétés est en train d'être construite, étape par étape, depuis les fondations.",
      ],
      timeline: {
