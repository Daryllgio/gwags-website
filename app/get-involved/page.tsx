    ...
    <main>
      ...
      <section className="gi-hero">
        <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
          ...
          <p style={{ color: 'rgba(255,255,255,0.85)', fontSize: '18px', lineHeight: 1.8, maxWidth: '550px', margin: 0 }}>
            {p.hero.body}
          </p>
        </div>
      </section>
      ...
      <section style={{ background: '#F7F6F3', padding: '80px 28px' }} className="gi-section">
        <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
          ...
          <p style={{ color: '#4A4A4A', fontSize: '18px', lineHeight: 1.85, maxWidth: '700px', marginBottom: '28px' }}>
            {p.partner.body}
          </p>
          <a href="#" style={{ color: '#D4AF37', fontSize: '15px', fontWeight: 500, textDecoration: 'underline', textDecorationColor: 'rgba(212,175,55,0.5)', textUnderlineOffset: '3px', cursor: 'pointer' }}>
            {p.partner.cta}
          </a>
        </div>
      </section>
      ...
      <section style={{ background: '#D4AF37', padding: '80px 28px', textAlign: 'center' }}>
        <div style={{ maxWidth: '600px', margin: '0 auto' }}>
          ...
          <p style={{ color: 'rgba(10,17,40,0.75)', fontSize: '18px', lineHeight: 1.75, marginBottom: '36px' }}>
            {p.cta.body}
          </p>
          <Link
            href="/"
