    ...
    <section className="hww-hero-section" style={{ background: '#0A1128' }}>
      <div className="hww-hero-grid">
        <div className="hww-hero-text">
          ...
          <h1 className="hww-hero-h1" style={{ color: '#ffffff', fontSize: '40px', fontWeight: 400, fontFamily: 'Georgia, serif', lineHeight: 1.18, margin: '0 0 28px 0' }}>
            {p.h1}
          </h1>
        ...
        <div className="hww-hero-img" style={{ position: 'relative', width: '100%' }}>
          <Image src="/images/general/IMG_4469.jpg" alt="How We Work" fill style={{ objectFit: 'cover', objectPosition: 'center 40%' }} />
        </div>
      </div>
    </section>
  )
